...
object Constants {
    ...
    const val RATE_ON_GOOGLE_PLAY = "https://github.com/dracinn/Metro"
    const val TRANSLATE = "https://crowdin.com/project/retromusicplayer"
    const val WEBSITE = "https://retromusic.app"
    const val GITHUB_PROJECT = "https://github.com/dracinn/Metro"
    ...
    const val FAQ_LINK = "https://github.com/dracinn/Metro/blob/dev/FAQ.md"
