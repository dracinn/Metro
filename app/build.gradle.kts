...
android {
    ...
    productFlavors {
        ...
        create("microg") {
            dimension = "version"
            applicationIdSuffix = ".microg"
            versionNameSuffix = " MicroG"
        }
    }
    sourceSets {
        getByName("microg") {
...
dependencies {
    ...
    "microgImplementation"(libs.google.play.services.cast.framework)
    "microgImplementation"(libs.nanohttpd)
